...
import androidx.activity.viewModels // <<<--- ADDED for by viewModels()
import androidx.compose.animation.ExperimentalAnimationApi
import androidx.compose.material3.MaterialTheme
import androidx.compose.material3.Surface
import androidx.compose.runtime.collectAsState
import androidx.compose.runtime.getValue // <<<--- ADDED for by collectAsState()
import androidx.core.splashscreen.SplashScreen.Companion.installSplashScreen
// import androidx.hilt.navigation.compose.hiltViewModel // No longer needed here if using activity-scoped VM
...
import kotlinx.coroutines.flow.first // <<<--- CORRECTED/ADDED for Flow.first
import kotlinx.coroutines.launch // <<<--- ADDED for lifecycleScope.launch
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // No need for keepSplashOnScreen logic here
        setContent {
